...
function EditProduk() {
    ...
    const fectData = React.useCallback(async () => {
        ...
        'https://192.168.43.172:7122/api/Produk/getById?id_produk='+ id_produk
        );
        //get response data
    ...
    try {
      ...
      const response = await axios({
        method: "put",
        url: "https://192.168.43.172:7122/api/Produk/update?id_produk=" + id_produk,
        data: FormDataInput,
